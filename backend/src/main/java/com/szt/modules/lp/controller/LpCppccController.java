...
import com.szt.modules.lp.service.LpCppccService;
...
@RestController
@RequestMapping("lp/lpcppcc")
@Controller("lplpcppcc")
public class LpCppccController {
    ...
    @ApiOperation("列表")
    @GetMapping("/list")
    @RequiresPermissions("lp:lpcppcc:list")
    ...
    @ApiOperation("信息")
    @GetMapping("/info/{id}")
    @RequiresPermissions("lp:lpcppcc:info")
    ...
    @ApiOperation("保存")
    @PostMapping("/save")
    @RequiresPermissions("lp:lpcppcc:save")
    ...
    @ApiOperation("修改")
    @PostMapping("/update")
    @RequiresPermissions("lp:lpcppcc:update")
    ...
    @ApiOperation("删除")
    @PostMapping("/delete")
    @RequiresPermissions("lp:lpcppcc:delete")
 ...
 /**
    ...
    public R selectTableConfig() {
        return R.ok().put("data",lpCppccService.selectTableConfig());
    }
}
