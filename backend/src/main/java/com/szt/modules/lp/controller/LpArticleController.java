...
@RestController
@RequestMapping("lp/lparticle")
@Controller("lplparticle")
public class LpArticleController {
    ...
    @ApiOperation("列表")
    @GetMapping("/list")
    @RequiresPermissions("lp:lparticle:list")
    ...
    @ApiOperation("信息")
    @GetMapping("/info/{id}")
    @RequiresPermissions("lp:lparticle:info")
    ...
    @ApiOperation("保存")
    @PostMapping("/save")
    @RequiresPermissions("lp:lparticle:save")
    ...
    @ApiOperation("修改")
    @PostMapping("/update")
    @RequiresPermissions("lp:lparticle:update")
    ...
    @ApiOperation("删除")
    @PostMapping("/delete")
    @RequiresPermissions("lp:lparticle:delete")
 ...
 /**
    ...
    public R selectTableConfig() {
        return R.ok().put("data",lpArticleService.selectTableConfig());
    }
}
