 ...
 * @date 2018-11-28 19:35:19
 */
@TableName("lp_image")
public class LpImageEntity implements Serializable {
    ...
    private String pic;
    /**
     * 摆放区@0-活动剪影,1-领导风采,2-资质荣誉,3-展销会
     */
    @NotBlank(message="摆放区不能为空")
    @ApiModelProperty(value = "摆放区@0-活动剪影,1-领导风采,2-资质荣誉,3-展销会",required = false)
    private String type;
    /**
     * 链接
     */
    ...
    /**
     * 设置：摆放区@0-活动剪影,1-领导风采,2-资质荣誉,3-展销会
     */
    public void setType(String type) {
        this.type = type;
    }
    /**
     * 获取：摆放区@0-活动剪影,1-领导风采,2-资质荣誉,3-展销会
     */
