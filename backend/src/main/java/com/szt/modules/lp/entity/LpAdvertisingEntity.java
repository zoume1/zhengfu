 ...
 * @date 2018-11-28 19:32:48
 */
@TableName("lp_advertising")
public class LpAdvertisingEntity implements Serializable {
    private static final long serialVersionUID = 1L;

    /**
     * 摆放区@0-首页轮播图,1-首页中部广告图
     */
    @NotBlank(message="摆放区不能为空")
    @ApiModelProperty(value = "摆放区@0-首页轮播图,1-首页中部广告图",required = false)
    private String type;
    /**
     * 图片
     */
    ...
    /**
     * 设置：摆放区@0-首页轮播图,1-首页中部广告图
     */
    public void setType(String type) {
        this.type = type;
    }
    /**
     * 获取：摆放区@0-首页轮播图,1-首页中部广告图
     */
