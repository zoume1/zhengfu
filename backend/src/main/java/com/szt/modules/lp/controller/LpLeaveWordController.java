...
import com.szt.modules.lp.service.LpLeaveWordService;
...
@RestController
@RequestMapping("lp/lpleaveword")
@Controller("lplpleaveword")
public class LpLeaveWordController {
    ...
    @ApiOperation("列表")
    @GetMapping("/list")
    @RequiresPermissions("lp:lpleaveword:list")
    ...
    @ApiOperation("信息")
    @GetMapping("/info/{id}")
    @RequiresPermissions("lp:lpleaveword:info")
    ...
    @ApiOperation("保存")
    @PostMapping("/save")
    @RequiresPermissions("lp:lpleaveword:save")
    ...
    @ApiOperation("修改")
    @PostMapping("/update")
    @RequiresPermissions("lp:lpleaveword:update")
    ...
    @ApiOperation("删除")
    @PostMapping("/delete")
    @RequiresPermissions("lp:lpleaveword:delete")
 ...
 /**
    ...
    public R selectTableConfig() {
        return R.ok().put("data",lpLeaveWordService.selectTableConfig());
    }
}
