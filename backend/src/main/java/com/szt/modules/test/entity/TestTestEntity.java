package com.szt.modules.test.entity;
 ...
 */
@TableName("test_test")
public class TestTestEntity implements Serializable {
    ...
    private Integer sort;
         ...
         * 视频上传
         */
            @NotBlank(message="视频上传不能为空")
    @ApiModelProperty(value = "视频上传",required = false)
