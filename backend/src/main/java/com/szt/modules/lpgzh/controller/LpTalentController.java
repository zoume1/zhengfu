...
import com.szt.modules.lpgzh.service.LpTalentService;
...
@RestController
@RequestMapping("lpgzh/lptalent")
@Controller("lpgzhlptalent")
public class LpTalentController {
    ...
    @ApiOperation("列表")
    @GetMapping("/list")
    @RequiresPermissions("lpgzh:lptalent:list")
    ...
    @ApiOperation("信息")
    @GetMapping("/info/{id}")
    @RequiresPermissions("lpgzh:lptalent:info")
    ...
    @ApiOperation("保存")
    @PostMapping("/save")
    @RequiresPermissions("lpgzh:lptalent:save")
    ...
    @ApiOperation("修改")
    @PostMapping("/update")
    @RequiresPermissions("lpgzh:lptalent:update")
    ...
    @ApiOperation("删除")
    @PostMapping("/delete")
    @RequiresPermissions("lpgzh:lptalent:delete")
