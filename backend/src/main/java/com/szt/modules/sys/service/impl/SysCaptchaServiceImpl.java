...
import com.szt.modules.sys.dao.SysAgreementDao;
...
public class SysCaptchaServiceImpl extends CommonServiceImpl<SysCaptchaDao, SysCaptchaEntity> implements SysCaptchaService {
    @Autowired
    ...
    public BufferedImage getCaptcha(String uuid) {
        ...
        this.insertEntity(captchaEntity);
