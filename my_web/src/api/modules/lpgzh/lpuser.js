...
export function list (params) {
  return request({
    url: requestUrl('/lppc/lpuser/list'),
    method: 'get',
...
export function info (id) {
  return request({
    url: requestUrl('/lppc/lpuser/info' + (isInteger(id) ? `/${id}` : '')),
    method: 'get',
...
export function add (params) {
  return request({
    url: requestUrl('/lppc/lpuser/save'),
    method: 'post',
...
export function saveAll (params) {
    return request({
        url: requestUrl('/lppc/lpuser/saveAll'),
        method: 'post',
        data: requestParam(params)
    })
}
...
export function update (params) {
  return request({
    url: requestUrl('/lppc/lpuser/update'),
    method: 'post',
    data: requestParam(params)
  })
}
...
export function del (params) {
  return request({
    url: requestUrl('/lppc/lpuser/delete'),
    method: 'post',
...
export function sort (params) {
  return request({
    url: requestUrl('/lppc/lpuser/sort'),
    method: 'post',
    data: requestParam(params, 'post', false)
  })
}
...
export function login (params) {
  return request({
    url: requestUrl('/lppc/lpuser/login'),
    method: 'get',
    params: requestParam(params, 'get', false)
  })
}
