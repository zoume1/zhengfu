<template>
    <div>
     ...
     <!-- <el-row :gutter="20" v-else-if="field.inputType=='14'">
      ...
      <!--上传附件-->
      <el-form-item   :prop="field.fieldName" v-else-if="field.inputType=='19'" >
        <div   class="el-input el-input-group el-input-group--prepend el-input--suffix" >
          <div class="el-input-group__prepend" v-if="isPage"><label  class="el-form-item__label" style="padding: 0;line-height: initial;">{{field.pageComment}}</label></div>
         <attachment v-model="data"></attachment>
        </div>
      </el-form-item>
        <!--上传视频-->
        <el-form-item   :prop="field.fieldName" v-else-if="field.inputType=='20'" >
          <div   class="el-input el-input-group el-input-group--prepend el-input--suffix" >
            <div class="el-input-group__prepend" v-if="isPage"><label  class="el-form-item__label" style="padding: 0;line-height: initial;">{{field.pageComment}}</label></div>
            <videos v-model="data"></videos>
          </div>
      </el-form-item>
      <!--普通文本框-->
...
<script>
  ...
  import attachment from '@/components/input/uploadAttachment.vue'
  import videos from '@/components/input/uploadVideo.vue'
    export default {
        name: "field",
        data(){
          return {
