    ...
    <div class="mod-config">
      ...
      <el-card class="box-card">
        <div slot="header" class="clearfix">
          <span>六盘水市场(包括下级组织)团体会员统计表</span>
        </div>
        <div  class="text item">
          ...
          <el-table
            ...
            <el-table-column
              ...
              <!-- <template slot-scope="scope">
                 &lt;!&ndash;下拉选selec&ndash;&gt;
                 <span v-text="typeData.map[scope.row['grade']]"> </span>
               </template>-->
            </el-table-column>
            <el-table-column
              prop="count"
...
<script>
  ...
  // register component to use
    export default {
      ...
      mounted() {
        API[this.pathUrl].memberStatistics({type:"2"}).then(({data}) => {
