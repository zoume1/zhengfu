<template>
    <div class="mod-config">
        <tablefield order="ascending" :pathUrl="pathUrl" ref="tablefield" :formButton="formButton":dataForm.sync="dataForm"  :setListSelections="setListSelections" :saveForm="saveForm" :model="model" :operation.sync="operation" orderBy="sort"></tablefield>
    </div>
</template>
