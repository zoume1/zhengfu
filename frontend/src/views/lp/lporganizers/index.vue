<template>
    <div class="mod-config">
        <tablefield :pathUrl="pathUrl" ref="tablefield" :seekForm="seekForm":formButton="formButton":dataForm.sync="dataForm"  :setListSelections="setListSelections" :saveForm="saveForm" :model="model" :operation.sync="operation"></tablefield>
    </div>
</template>
