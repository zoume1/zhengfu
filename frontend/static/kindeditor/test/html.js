...
test("formatUrl", function() {
	...
	equals(K.formatUrl(K.query("#test02").value, "absolute", 'http://localhost:8089', '/ke/test'), '/images/xxx.gif');
	equals(K.formatUrl(K.query("#test02").value, "relative", 'http://localhost:8089', '/ke/test'), '../../images/xxx.gif');
	equals(K.formatUrl(K.query("#test02").value, "domain", 'http://localhost:8089', '/ke/test'), 'http://localhost:8089/images/xxx.gif');
